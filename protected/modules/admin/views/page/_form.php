...
<div class="form well">
    ...
    <p class="help-block hint">        
        <?php echo tt('Fields with <span class="required">*</span> are required.');?>
    </p>
    <br/>
            <p>
         ...
         <div class="row" >
                            ...
                            <?php echo $form->dropDownlist($model,'type',  CMap::mergeArray(array(''=>'Выберите раздел'),Menu::loadMenu()),array('class'=>'span3')); ?>
        ...
        <div class="hint">
            Заголовок страницы максимум 128 символов. Не должен содержать никаких символов, кроме букв.        
        </div>
	<br/>
	 ...
	 <div class="row" >
         ...
         -->
                <?php $this->widget('bootstrap.widgets.TbButton', array(
                   ...
                   // 'type'=>'danger',
                    'htmlOptions'=>array(
                        'data-title'=>'Допустимый формат изображений:', 
                        'data-content'=>'.jpg .jpeg. .png .gif', 
