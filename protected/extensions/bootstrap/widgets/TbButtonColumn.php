...
class TbButtonColumn extends CButtonColumn
{
        ...
        public $htmlOptions=array('width'=>'140px;');
	/**
	 ...
	 */
	public $viewButtonOptions=array('class'=>'btn view');
	/**
	 ...
	 */
	public $updateButtonOptions=array('class'=>'btn update');
	/**
	...
	public $deleteButtonIcon = 'trash';
        ...
        public $deleteButtonOptions=array('class'=>'btn delete');
